# 89f3dee929a2fdc8bf465c35870217f59504d6b3 encoding: utf-8
# @@ 1

########################### DO NOT MODIFY THIS FILE ###########################
#       This file was automatically generated by JRubyFX-fxmlloader on        #
# 2016-06-17 16:28:06 -0400 for C:/Users/Peter/PokemonEssentialsEditor/layout/editor-map.fxml
########################### DO NOT MODIFY THIS FILE ###########################
...
with(__local_fxml_controller) do
 ...
 setCenter(build(Java::JavafxSceneControl::SplitPane) do
  getItems.add(build(Java::JavafxSceneControl::ScrollPane) do
  ...
  getItems.add(build(Java::JavafxSceneControl::ScrollPane) do
   ...
   setContent(build(Java::JavafxScene::Group) do
    setId("map_group")
    __local_fx_id_setter.call("map_group", self)
   end)
   setPannable(true)
   setPrefHeight(200.0)
   setPrefWidth(200.0)
  ...
  setDividerPositions(*[0.2569573283858998])
 end)
 ...
 setPrefWidth(1280.0)
      ...
      def hash
        "89f3dee929a2fdc8bf465c35870217f59504d6b3"
      end
      def compiled?
        true
      end
