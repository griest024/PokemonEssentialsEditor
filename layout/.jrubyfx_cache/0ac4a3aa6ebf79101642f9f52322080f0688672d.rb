# 4d883a22ac3f220ad08f1c10feae6e18cdef38e9 encoding: utf-8
# @@ 1

########################### DO NOT MODIFY THIS FILE ###########################
#       This file was automatically generated by JRubyFX-fxmlloader on        #
# 2015-05-29 12:36:28 -0400 for /home/griest/pkmn-editor/PokemonEssentialsEditor/layout/editor-map.fxml
########################### DO NOT MODIFY THIS FILE ###########################
...
build(Java::JavafxSceneLayout::BorderPane) do
 ...
 setRight(build(Java::JavafxSceneControl::ScrollPane) do
  setId("autotile_scroll_pane")
  __local_fx_id_setter.call("autotile_scroll_pane", self)
  setPrefHeight(200.0)
  setPrefWidth(200.0)
  Java::JavafxSceneLayout::BorderPane.setAlignment(self, Java::javafx::geometry::Pos::CENTER)
 end)
 ...
 setPrefWidth(600.0)
      ...
      def hash
        "4d883a22ac3f220ad08f1c10feae6e18cdef38e9"
      end
      def compiled?
        true
      end
