# c04d8ffb1b2f24f265fd1f67df0279d63e85b18a encoding: utf-8
# @@ 1

########################### DO NOT MODIFY THIS FILE ###########################
#       This file was automatically generated by JRubyFX-fxmlloader on        #
# 2016-06-05 21:38:04 -0400 for C:/Users/Peter/PokemonEssentialsEditor/layout/editor-main.fxml
########################### DO NOT MODIFY THIS FILE ###########################
...
build(Java::JavafxSceneLayout::VBox) do
 ...
 getChildren.add(build(Java::JavafxSceneControl::SplitPane) do
  ...
  getItems.add(build(Java::ComPanemuTiwulfxControl::DetachableTabPane) do
  end)
 ...
 setPrefWidth(1280.0)
      ...
      def hash
        "c04d8ffb1b2f24f265fd1f67df0279d63e85b18a"
      end
      def compiled?
        true
      end
