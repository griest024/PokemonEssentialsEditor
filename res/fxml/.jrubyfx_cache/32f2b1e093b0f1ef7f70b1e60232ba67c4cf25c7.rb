# acf4008af676898edcec5a4cb7246107b45b75db encoding: utf-8
# @@ 1

########################### DO NOT MODIFY THIS FILE ###########################
#       This file was automatically generated by JRubyFX-fxmlloader on        #
# 2016-06-30 16:16:30 -0400 for C:/Users/Peter/PokemonEssentialsEditor/res/fxml/editor-main.fxml
########################### DO NOT MODIFY THIS FILE ###########################
...
build(Java::JavafxSceneLayout::BorderPane) do
  ...
  getItems.add(build(Java::JavafxSceneControl::MenuBar) do
   getMenus.add(build(Java::JavafxSceneControl::Menu) do
    ...
    getItems.add(build(Java::JavafxSceneControl::Menu) do
     ...
     getItems.add(build(Java::JavafxSceneControl::MenuItem) do
      setId("menu_file_open_file")
      __local_fx_id_setter.call("menu_file_open_file", self)
      ...
      setMnemonicParsing(false)
      setText("Open File...")
      setOnAction(EventHandlerWrapper.new(__local_fxml_controller, "fileOpenDialog"))
     end)
     getItems.add(build(Java::JavafxSceneControl::MenuItem) do
      setId("menu_file_open_project")
      __local_fx_id_setter.call("menu_file_open_project", self)
      setMnemonicParsing(false)
      setText("Open Project...")
      setOnAction(EventHandlerWrapper.new(__local_fxml_controller, "projectOpenDialog"))
     end)
     setMnemonicParsing(false)
     setText("Open")
    end)
    ...
    getItems.add(build(Java::JavafxSceneControl::MenuItem) do
     setId("menu_file_save_as")
     __local_fx_id_setter.call("menu_file_save_as", self)
 ...
 setPrefWidth(942.0)
      ...
      def hash
        "acf4008af676898edcec5a4cb7246107b45b75db"
      end
      def compiled?
        true
      end
